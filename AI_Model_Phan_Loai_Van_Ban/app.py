...
st.set_page_config(page_title="AI Phân loại Văn bản", layout="centered")
...
if model is None:
    st.warning("Không tìm thấy mô hình. Vui lòng chạy file `train_model.py` để huấn luyện ra dữ liệu mô hình trước.")
else:
